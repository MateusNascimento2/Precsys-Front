    ...
    <>
      ...
      <nav className={show ? 'shadow border-r border-neutral-300 fixed flex items-start bg-white w-[300px] z-50 h-screen top-[50px] left-0 px-4 lg:static lg:w-full lg:h-full lg:shadow-none lg:border-0 dark:bg-neutral-900 dark:border-neutral-700 lg:flex lg:items-center' : 'border-r dark:border-neutral-700 flex items-start bg-[#FFF] w-[300px] z-50 fixed top-[52px] left-[-300px] h-screen dark:bg-neutral-900 lg:transition-none lg:duration-0'}>
        <ul className={auth.user.admin ? 'divide-y divide-neutral-300 dark:divide-neutral-700 flex w-full px-2 flex-col items-center gap-2 text-[13px] lg:flex-row lg:divide-y-0' : 'divide-y divide-neutral-300 dark:divide-neutral-700 flex w-full px-2 flex-col items-start lg:items-center gap-2 text-[13px] lg:flex-row lg:divide-y-0'}>
          ...
          {auth.user.admin ? <li onClick={() => handleShow('pessoal')} className='cursor-pointer w-full p-2 lg:px-2  lg:border-0 lg:hover:bg-neutral-100 lg:dark:hover:bg-neutral-800 hover:rounded'>
            ...
            <ul className='flex flex-col lg:flex-row lg:items-center divide-y divide-neutral-300 dark:divide-neutral-700 lg:divide-y-0 w-full'>
              ...
              <li className='p-2 rounded cursor-pointer hover:bg-neutral-100 dark:hover:bg-neutral-800' onClick={() => handleRoute('/clientes')}>
                <span className='font-[500] text-[#666666] dark:text-neutral-300 '>Meus Clientes</span>
                {auth.user.admin ? <p className='font-[500] text-[#666666] dark:text-neutral-500'>Ver os Meus Clientes</p> : null}
              </li>
            </ul>
          }

          {auth.user.admin ? <li onClick={() => handleShow('controle')} className='cursor-pointer w-full p-2 lg:px-2  lg:border-0 lg:hover:bg-neutral-100 lg:dark:hover:bg-neutral-800 hover:rounded'>
            <div className='flex justify-between items-center lg:gap-3'>
          ...
          {auth.user.admin ? <li onClick={() => handleShow('logs')} className='cursor-pointer w-full p-2 lg:px-2 lg:border-0 lg:hover:bg-neutral-100 lg:dark:hover:bg-neutral-800 hover:rounded'>
            <div className='flex justify-between items-center lg:gap-3 '>
