              ...
              <>
                ...
                <div>
                  <form className="flex flex-col gap-4">
                    ...
                    {showErrorMessage ? (<div className='bg-red-400 px-4 py-3 rounded'>{errorMessageText === 'CPF/CNPJ inválido.' ? (<span className="flex gap-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
