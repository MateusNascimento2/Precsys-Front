...
function FileInput({ label, name, handleCessionarioInputChange, handleCessaoInputChange, cessionarioId }) {
  ...
  return (
    <div className='dark:text-white text-black flex flex-col md:items-start gap-1 w-full'>
      ...
      <label className='w-full relative'>
        ...
        }} className='font-semibold text-neutral-400 rounded-full p-0.5 absolute top-0.5 right-1'>
