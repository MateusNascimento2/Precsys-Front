...
export function FormAdicionarCessao({ formDataCessao, handleCessaoInputChange, orcamentos, anosOrcamento, handleAnoOrcamento, empresas, teles, juridico, varas, natureza, escrevente }) {
    ...
    <div className='grid grid-cols-1 gap-4 lg:grid-cols-2'>
      ...
      <div className='flex flex-col gap-4'>
          ...
          <div className='flex flex-col gap-2 lg:gap-0 lg:flex-row'>
            <Select
              ...
              value={formDataCessao.ente_id
                ? { value: formDataCessao.ente_id, label: orcamentos.find(orcamento => orcamento.id === formDataCessao.ente_id)?.ente }
                : null
              }
        ...
        <div className='dark:text-white text-black flex flex-col justify-center md:items-start gap-1 w-full'>
          ...
          <FileInput label={'Escritura'} name={'escritura'} handleCessaoInputChange={handleCessaoInputChange} />
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div className='dark:text-white text-black flex flex-col gap-1'>
          ...
          <input
            ...
            name='data_cessao'
            id='data_cessao'
            className='dark:bg-neutral-800 border rounded dark:[color-scheme:dark] dark:border-neutral-600 h-[34px] py-1 px-2 focus:outline-none placeholder:text-[14px] text-gray-400'
        ...
        {/* Requisitório */}
        <div className='dark:text-white text-black flex flex-col justify-center md:items-start gap-1 w-full'>
          <FileInput label={'Requisitório'} name={'requisitorio'} handleCessaoInputChange={handleCessaoInputChange} />
        </div>
      </div>
    </div>
  )
