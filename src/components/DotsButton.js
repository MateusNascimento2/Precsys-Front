...
export default function DotsButton({ children }) {
  ...
  return (
    ...
    <div className="relative" ref={ref}>
      ...
      <div className={show ? "bg-white border shadow absolute rounded top-4 right-0 z-40 px-1 py-1 gap-1 flex flex-col dark:bg-neutral-900 dark:border-neutral-700" : "bg-white dark:bg-neutral-900 border shadow absolute rounded top-4 right-0 z-40 px-1 py-1 gap-1 hidden"}>
        {children}
      </div>
    </div>
