...
export default function Modal({ botaoAbrirModal, children, botaoSalvar, botaoAdicionarCessionario, tituloModal, width }) {
      ...
      {show && (
        <>
          ...
          >
            ...
            />
            <motion.div
              className={`bg-white dark:bg-neutral-900 dark:border-neutral-600 border rounded shadow z-[200] relative w-[85%] lg:w-[980px] xl:w-[90%] py-2 md:pb-[20px] md:w-[600px]`}
