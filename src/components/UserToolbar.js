  ...
  return (
    <>
      <AnimatePresence>
        {show && (
          <motion.section
            className="cursor-auto shadow rounded right-0 absolute flex flex-col px-4 items-start bg-[#FFF] dark:bg-neutral-900 dark:text-white dark:border-neutral-600 border w-[300px] z-50 top-[calc(0vh+40px)] lg:top-[calc(0vh+45px)]"
