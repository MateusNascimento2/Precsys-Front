...
function UserToolbar({ show, updateLogo, darkMode, onDarkModeChange }) {
  ...
  return (
    <>
      <section className={show ? 'cursor-auto shadow rounded right-0 absolute flex flex-col px-4 items-start bg-[#FFF] dark:bg-neutral-900 dark:text-white dark:border-neutral-600 border w-[300px] z-50 top-[calc(0vh+40px)] transition-opacity delay-100 opacity-100' : 'rounded right-0 transition-opacity delay-100 flex flex-col items-start w-[300px] z-50 fixed top-[-100vh] opacity-0'}>
