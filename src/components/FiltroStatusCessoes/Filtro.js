    ...
    <>
      ...
      <div className={`${show
        ...
        <div className='divide-y dark:divide-neutral-600'>
          <AbaFiltro abaNome={'Status Atual'} dadosFiltro={dadosFiltro.status} selectedFilters={selectedFilters['status']} handleFilterChange={(value) => handleFilterChange('status', value)} />
          
          <AbaFiltro abaNome={'Status Antigo'} dadosFiltro={dadosFiltro.status} selectedFilters={selectedFilters['status_antigo']} handleFilterChange={(value) => handleFilterChange('status_antigo', value)} />

          <AbaFiltro abaNome={'Data da Modificação'} selectedFilters={selectedFilters['data_cessao']} handleDateChange={handleDateChange} />
        </div>
      </div>
    </>
  )
