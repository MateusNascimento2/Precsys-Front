...
{/*             <div className="hidden lg:block lg:sticky lg:top-[5%]">
              <PropostasLogsFilter show={true} onSetShow={handleShow} filters={filters} onSelectedCheckboxesChange={updateFilters} resetFilters={resetFilters} />
            </div> */}
        ...
        {/* <PropostasLogsFilter show={show} onSetShow={handleShow} filters={filters} onSelectedCheckboxesChange={updateFilters} resetFilters={resetFilters} /> */}
      </main>
    </>
  );
}