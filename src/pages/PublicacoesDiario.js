...
export default function PublicacoesDiario({ numeroPrecatorio }) {
  ...
  const itensPorPagina = !pathname.includes('cessao') ? 100 : 3;
  ...
  const fetchPublicacoes = async () => {
    try {
      ...
      const { data } = await axiosPrivate.get('/publicacoes-diario', {
        ...
        params: {
          search: pathname.includes('cessao') ? numeroPrecatorio : searchQuery,
          dataInicial,
          pagina: paginaAtual,
      ...
      {!pathname.includes('cessao') ?
        ...
        isLoading ?
          ...
          totalResultados !== 0
            ...
            <main className={'container mx-auto dark:bg-neutral-900 h-full'} id='publicacoes'>
              <div>
                <div className='flex items-center md:items-end'>
                  ...
                  <motion.h2
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8 }}
                    className='font-[700] dark:text-white mb-2'
                  >
                    Publicações
                  </motion.h2>
                </div>
                    ...
                    <div className={`lg:flex lg:gap-4 lg:items-start`}>
                      ...
                      <div className='flex flex-col gap-1 w-full'>
                        <div className='w-full h-full max-h-full'>
                          ...
                          <PublicacoesDiarioList publicacoesFiltradas={publicacoes} publicacoesQtd={totalResultados} isPaginaPrecatorio={pathname.includes('cessao')} />
