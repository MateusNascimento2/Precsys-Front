...
const GerarPDFPropostaPRC = ({ details }) => {
  ...
  const { beneficiario, cpfcnpj, precatorio, processo, proposta, nome, folder } = propostaDetails;
        ...
        <div className="w-full mt-4 py-[20px]">
          <div className="flex mx-[30px] items-start">
            <div className="text-left flex-1">
              ...
              <div className="text-[13px] text-gray-500">{beneficiario}</div>
              <div className="text-[14px] font-bold text-gray-900">CPF/CNPJ</div>
              <div className="text-[13px] text-gray-500">{cpfcnpj}</div>
              <div className="text-[14px] font-bold text-gray-900">PRECATÓRIO</div>
              <div className="text-[13px] text-gray-500">{precatorio}</div>
              <div className="text-[14px] font-bold text-gray-900">PROCESSO</div>
              <div className="text-[13px] text-gray-500">{processo}</div>
              <div className="text-[14px] font-bold text-gray-900">PROPOSTA</div>
              <div className="text-[13px] text-gray-500">{proposta}</div>
            </div>
